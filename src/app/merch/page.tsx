      ...
      <main className="min-h-screen p-6 bg-gray-900 text-white font-highway text-center pt-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 justify-center items-center">
          ...
          <div className="bg-black p-4 rounded-lg shadow-lg">
            <img src="/merch/tour shirt.webp" alt="Parkways Shirt 1" className="w-full rounded-lg" />
            <p className="mt-2 text-lg font-bold">Original Shirt</p>
          </div>
          
          {/* Shirt 2 */}
          <div className="bg-black p-4 rounded-lg shadow-lg">
            <img src="/merch/KellyGreen.webp" alt="Parkways Kelly Green" className="w-full rounded-lg" />
            <p className="mt-2 text-lg font-bold">Kelly Green Shirt</p>
          </div>
          
          {/* Sticker */}
          <div className="bg-black p-4 rounded-lg shadow-lg">
            <img src="/merch/Stickers.webp" alt="Parkways Sticker" className="w-full rounded-lg" />
